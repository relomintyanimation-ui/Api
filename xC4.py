...
async def Emote_k(TarGeT, idT, K, V, region="IND"):
    # Perform Emote Packet
    fields = {
        1: 21,
        2: {
            1: 804266360, # Dummy Value (Might need update)
            2: 909000001,
            5: {1: TarGeT, 3: idT}
        }
    }
    packet_id = '0514' if region == "IND" else '0515'
    return await GeneRaTePk((await CrEaTe_ProTo(fields)).hex(), packet_id, K, V)
